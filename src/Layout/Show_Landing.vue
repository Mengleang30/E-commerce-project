  ...
  <div class="ShowLanding">
    <div class="left_show">
      <div class="wrap_quick_link">
        <div class="wrap_btn">
          <button>
            <RouterLink class="link" to="/list-book">Our Product</RouterLink>
          </button>
      ...
      <div class="showing">
        <h1>Huge collection of <strong>best books</strong></h1>
        ...
        <p>
          An online book is a resource in book-like form that is only available
          to read on the internet. It differs form the common idea of an e-book
        </p>
      </div>
      <div class="form">
        <div class="wrap_form">
        ...
        <div class="wrap_grid">
          <div class="container_explore">
            <div
              ...
              @click="handleSearchByCategory(list)"
              class="child"
            >
              {{ list }}
            </div>
    ...
    <div class="backToTop" @click="ScrollToTop">
      <img
        src="https://img.icons8.com/?size=100&id=80689&format=png&color=000000"
        alt="Back To Top"
      />
    </div>
  </div>
